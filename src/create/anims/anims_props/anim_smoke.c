...
static shape_t *start(void)
{
    ...
    sfRectangleShape_setPosition(rect, (v2f_t){1805, 540});
    sfRectangleShape_setSize(rect, (v2f_t){70, 20});
...
static shape_t *end(void)
{
    ...
    sfRectangleShape_setPosition(rect, (v2f_t){1650, -100});
...
{
    anim_props_t *anim = create_anim_props(BIN_SMOKE_ANIM, NULL,
        start(), end());
    return anim;
}
